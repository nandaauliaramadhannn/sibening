...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var baseURL = 'http://127.0.0.1:8000/'; //Base URL
    ...
    function init_template(){
        ...
        highlightData.forEach(el => el.addEventListener('click', e =>{
            ...
            loadHighlight.href = baseURL+'styles/highlights/' + highlight +'.css';
        ...
        var rememberHighlight = localStorage.getItem(pwaName+'-Highlight');
	        if(rememberHighlight){
	            ...
	            loadHighlight.className = "page-highlight";
	            loadHighlight.type = "text/css";
	            loadHighlight.href = baseURL+'styles/highlights/' + rememberHighlight +'.css';

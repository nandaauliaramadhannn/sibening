    ...
    <div class="card card-style">
        <div class="content px-2 text-center">
            ...
            <div class="row text-center row-cols-3 mb-n1">
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/7t.jpg') }}" title="Vynil and Typerwritter">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/7s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/23t.jpg') }}" title="Cream Cookie">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/23s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/3t.jpg') }}" title="Cookies and Flowers">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/3s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/11t.jpg') }}" title="Vynil and Typerwritter">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/11s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/5t.jpg') }}" title="Cream Cookie">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/5s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
                <a class="col p-1" data-gallery="gallery-1" href="{{ asset('images/pictures/15t.jpg') }}" title="Cookies and Flowers">
                    <img src="{{ asset('images/empty.png') }}" data-src="{{ asset('images/pictures/14s.jpg') }}" class="preload-img img-fluid rounded-m" alt="img">
                </a>
            </div>
        </div>
    </div>

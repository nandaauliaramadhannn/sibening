			...
			<div class="dropdown-menu  bg-transparent border-0 mt-n1 ms-3">
				<div class="card card-style rounded-m shadow-xl mt-1 me-1">
					<div class="list-group list-custom list-group-s list-group-flush rounded-xs px-3 py-1">
						<a href="#" class="color-theme opacity-70 list-group-item py-1"><strong class="font-500 font-12">Your Profile</strong><i class="bi bi-chevron-right"></i></a>
						<a href="#" class="color-theme opacity-70 list-group-item py-1"><strong class="font-500 font-12">Notifications</strong><i class="bi bi-chevron-right"></i></a>
						<a href="#" class="color-theme opacity-70 list-group-item py-1"><strong class="font-500 font-12">Log Out</strong><i class="bi bi-chevron-right"></i></a>
					</div>
				</div>
			</div>
		</div>
...
<div class="menu-content px-3 d-none">
	<div class="card card-style rounded-m p-2 mx-0 bg-theme mb-0">
		<div class="menu-list">
			...
			<a href="#"><img src="{{ asset('images/avatars/2s.png') }}" alt="img" class="gradient-green"><span class="font-500 color-theme">Marcus Green</span><em class="badge badge-s bg-red-dark">5</em></a>
			<a href="#"><img src="{{ asset('images/avatars/5s.png') }}" alt="img" class="gradient-blue"><span class="font-500 color-theme">Danny Blueish</span><em class="badge badge-s bg-red-dark">1</em></a>
		</div>
	</div>
</div>
...
<div class="menu-content px-3 d-none">
	<div class="card card-style rounded-m p-2 mx-0 bg-theme">
		<a href="#">
			<div class="d-flex">
				<div class="align-self-center">
					<img src="{{ asset('images/pictures/14s.jpg') }}" class="rounded-s me-2" width="60" alt="img">
				</div>
				<div class="align-self-center">
		...
		<a href="#">
			<div class="d-flex">
				<div class="align-self-center">
					<img src="{{ asset('images/pictures/5s.jpg') }}" class="rounded-s me-2" width="60" alt="img">
				</div>
				<div class="align-self-center">
		...
		<a href="#">
			<div class="d-flex">
				<div class="align-self-center">
					<img src="{{ asset('images/pictures/11s.jpg') }}" class="rounded-s me-2" width="60" alt="img">
				</div>
				<div class="align-self-center">
